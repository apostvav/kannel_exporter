...
Using native malloc."""
    ...
    def check_smsc_metrics(self, metrics):
        ...
        self.assertEqual(metrics[6].documentation, 'SMSC uptime in seconds (*)')
        self.assertEqual(metrics[6].samples[0].value, 178)
        self.assertEqual(metrics[6].samples[1].value, 41)
